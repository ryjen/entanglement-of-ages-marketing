# Cinematic site concept reference

This document preserves a visual target for the next marketing-site refinement. It is a **design reference**, not a production screenshot, canon artifact, approved story copy, or literal pixel specification.

![The Fatherless cinematic landing-page concept](reference/site-concept-v1.webp)

## What to carry into the site

Use the concept primarily as a composition and hierarchy target:
...
- large visual book/era panels that make the The Fatherless, Neurion, Age of Embers, and The Age of Forms understandable at a glance;
...
## What is illustrative, not prescriptive

Do **not** treat the mockup's exact words, symbols, colors, character silhouettes, or imagery as approved canon or production content.
...
- The Fatherless must remain a prestige political-drama aesthetic rather than a Biblical-film poster;
...
- purpose: landing-page visual direction and implementation reference;
- source: project-generated concept image;
- production status: reference only, intentionally outside deployable `src/`;
- rights: project creative asset, All Rights Reserved under `RIGHTS.md`;
- implementation authority: `docs/visual-system.md`, `docs/image-direction.md`, and the public manifest take precedence where this concept differs from approved production rules.
